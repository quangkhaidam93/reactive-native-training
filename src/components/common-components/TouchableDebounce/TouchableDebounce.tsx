...
export interface TouchableDebounceProps extends PropsWithChildren<TouchableOpacityProps> {
    /**
...
const TouchableDebounce = React.forwardRef<TouchableOpacity, TouchableDebounceProps>((props, ref) => {
